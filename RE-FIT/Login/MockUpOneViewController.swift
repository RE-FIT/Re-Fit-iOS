...
class MockUpOneViewController: UIViewController {
    ...
    @objc func respondToSwipeGestureLeft(_ gesture: UIGestureRecognizer){
        if let swipeGesture = gesture as? UISwipeGestureRecognizer {
            ...
            case UISwipeGestureRecognizer.Direction.left:
                // 스와이프 시, 원하는 기능 구현.
                guard let rvc = self.storyboard?.instantiateViewController(withIdentifier: "MockUpTwoVC") as? MockUpTwoViewController else {return}
