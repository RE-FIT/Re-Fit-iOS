...
class FindTabViewController: TabmanViewController {
    ...
    private func setupTabMan(){
        let vc1 = UIStoryboard.init(name: "Login", bundle: nil).instantiateViewController(withIdentifier: "TabIDVC") as! TabIDViewController
        let vc2 = UIStoryboard.init(name: "Login", bundle: nil).instantiateViewController(withIdentifier: "TabPWVC") as! TabPWViewController
...
extension FindTabViewController: PageboyViewControllerDataSource, TMBarDataSource {
